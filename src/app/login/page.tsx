...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
      ...
      {/* Background Orbs */}
      <div className="bg-orb bg-orb-purple w-[400px] h-[400px] -top-20 -left-20 animate-pulse-glow" />
      <div className="bg-orb bg-orb-cyan w-[300px] h-[300px] bottom-20 -right-20 animate-pulse-glow" style={{ animationDelay: '1s' }} />
